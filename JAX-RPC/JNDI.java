...
public class BookQuote_Impl_2 implements BookQuote {
  public float getBookPrice(String isbn){
    ...
    try {
      ...
      javax.sql.DataSource dataSource = (javax.sql.DataSource) jndiEnc.lookup("java:comp/env/jdbc/DataSource");
      jdbcConnection = dataSource.getConnection();
      sqlStatement = jdbcConnection.createStatement();
      
      resultSet = sqlStatement.executeQuery("SELECT wholesale FROM CATALOG WHERE isbn = \'"+isbn+"\'");
